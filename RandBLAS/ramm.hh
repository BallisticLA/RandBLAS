...
// =============================================================================
/// \fn right_sketch(blas::Layout layout, blas::Op transA, int64_t m,
///    T alpha, const T *A, int64_t lda, SKOP &S,
...
/// @verbatim embed:rst:leading-slashes
/// What are :math:`\mat(A)` and :math:`\mat(B)`?
///     Let :math:`(d, n) = (S.\texttt{n_rows}, S.\texttt{n_cols})`.
///     The shapes of :math:`\mat(A)` and :math:`\mat(B)` are defined implicitly by
///     :math:`(m, d, n, \transA)`.
///     Their precise contents are determined by :math:`(A, \lda)`, :math:`(B, \ldb)`,
///     and "layout", following the same convention as BLAS.
///
